...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> NoSpecifiedProductInWarehouseException
    ...
    public ResponseEntity<ErrorResponse> handleNoDeliveryFoundException(NoDeliveryFoundException ex) {
        ErrorResponse errorResponse = new ErrorResponse();
        errorResponse.setHttpStatus("404 NOT_FOUND");
        errorResponse.setUserMessage(ex.getMessage());
        errorResponse.setEx("NoDeliveryFoundException");
        errorResponse.setMessage(ex.getMessage());
        errorResponse.setStackTrace(getStackTrace(ex));
        return new ResponseEntity<>(errorResponse, HttpStatus.NOT_FOUND);
    }
